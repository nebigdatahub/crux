# Generated by Django 2.0.5 on 2018-05-22 06:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('on', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Analysis')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_type', models.CharField(choices=[('CRE', 'CREATE'), ('UPD', 'UPDATE'), ('DEL', 'DELETE')], default='UPD', max_length=2)),
                ('by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('on', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Dataset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='files', to='app.Analysis')),
                ('dataset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='files', to='app.Dataset')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_type', models.CharField(choices=[('CRE', 'CREATE'), ('UPD', 'UPDATE'), ('DEL', 'DELETE')], default='UPD', max_length=2)),
                ('by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('on', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Task')),
            ],
            options={
